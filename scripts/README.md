...
| `scripts/admin/` | `generate_schedule_slots.py`, `assign_content_to_schedule_slots.py`, `schedule_draft_content.py` | Operator manually from local machine | Yes — scheduling and queue tables when `--execute` is passed |
